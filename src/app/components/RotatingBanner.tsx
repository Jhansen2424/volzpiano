...
const IconStrip = ({ flip = false }: { flip?: boolean }) => (
  ...
  >
    {/* Piano keys — filled */}
    <svg viewBox="0 0 40 28" className="h-10 w-12 text-orange-brand">
    ...
    {/* Music note — filled */}
    <svg viewBox="0 0 24 28" className="h-10 w-7 text-orange-brand">
    ...
    {/* House — filled */}
    <svg viewBox="0 0 28 28" className="h-10 w-8 text-orange-brand">
      <path d="M14 3L2 14h4v10h7v-7h2v7h7V14h4L14 3z" fill="currentColor" />
    </svg>

    {/* Treble clef — bolder */}
    <svg viewBox="0 0 20 32" className="h-11 w-6 text-orange-brand">
    ...
    {/* Star — filled */}
    <svg viewBox="0 0 24 24" className="h-9 w-9 text-orange-brand">
      <path d="M12 2l2.5 7.5H22l-6 4.5 2.5 7.5L12 17l-6.5 4.5L8 14 2 9.5h7.5L12 2z" fill="currentColor" />
    </svg>

    {/* Metronome — filled */}
    <svg viewBox="0 0 24 30" className="h-10 w-7 text-orange-brand">
  ...
  return (
    <section className="relative overflow-hidden bg-zinc-900 py-7 sm:py-9">
      ...
      <div className="mx-auto flex items-center justify-center gap-6 px-6 sm:gap-10">
        ...
        {/* Divider */}
        <div className="hidden h-10 w-px bg-orange-brand/40 sm:block" />
